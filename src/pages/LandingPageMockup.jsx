    ...
    <div className="relative min-h-screen bg-[#E8E6D7] text-[#35503A] font-sans overflow-x-hidden">
      ...
      <div className="relative pt-[14px]">
        ...
        <div className="w-full">
          <section className="relative mt-4 w-full border-y border-[#c6bd9f] bg-[#FCEDE2] bg-[url('/assets/bg.svg')] bg-cover bg-center">
            <div className="max-w-[1280px] mx-auto px-3 lg:px-4 py-4 sm:py-6 lg:py-8">
              ...
              <div className="mt-6 bg-[#FCEDE2] rounded-[16px] border border-[#d2cab1] shadow-[0_0_0_1px_rgba(120,86,68,0.06),0_10px_24px_-8px_rgba(120,86,68,0.22)] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-[#d2cab1]">
              ...
              <div className="mt-5 grid lg:grid-cols-2 gap-5 min-w-0">
                <article id="buy" className="bg-[#FCEDE2] rounded-[18px] border border-[#d2cab1] shadow-[0_0_0_1px_rgba(120,86,68,0.06),0_10px_24px_-8px_rgba(120,86,68,0.22)] p-4 sm:p-5 min-w-0">
                  ...
                  <div className="mt-4 flex items-start justify-between gap-3 min-w-0">
                    ...
                    <div className="w-20 h-20 rounded-[8px] bg-[#FCEDE2] border border-[#cabf9f] flex items-center justify-center text-[16px] shrink-0 font-mono">QR</div>
                  </div>
                ...
                <article id="tokenomics" className="bg-[#FCEDE2] rounded-[18px] border border-[#d2cab1] shadow-[0_0_0_1px_rgba(120,86,68,0.06),0_10px_24px_-8px_rgba(120,86,68,0.22)] p-4 sm:p-5 flex flex-col min-w-0">
                  <h3 className="text-[28px] sm:text-[34px] leading-[1.1] font-bold break-words">Tokenomics</h3>
                  <div className="mt-3 min-w-0">
                    <div className="rounded-[12px] border border-dashed border-[#cabf9f] bg-[#FCEDE2] h-[240px] sm:h-[280px] flex items-center justify-center">
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <div className="mt-2 flex items-center justify-center gap-2 sm:gap-3">
                        <div className="min-w-[64px] sm:min-w-[76px] rounded-[10px] border border-[#d2cab1] bg-[#FCEDE2] py-2 px-3">
